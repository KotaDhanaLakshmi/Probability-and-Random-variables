\let\negmedspace\undefined 
 ...
 \providecommand{\rsbrak}[1]{\ensuremath{{}\left.#1\ri]}} 
...
\begin{tabular}{|c|c|c|}
\hline
Randon variable   & value of R.V   & Probability\\
\hline
X      & x=1,2    &  1/2 \\
\hline
Y      & y=1,2,3,4    & 1/4 \\
...
\end{table}
 \begin{enumerate}[label=(\alph*)] 
				 ...
				 n\brak{S} = 52 .
                         \end{align} 
                 \item The probability when the card choosen is an ace\brak{Z=1} of spades\brak{Y=1} ,
                         \begin{align} 
